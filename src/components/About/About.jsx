        ...
        <div className='grid grid-cols-1 gap-1 w-[90%] m-auto my-3'>
            ...
            <NoBGComponent title="title">
                ...
                <h1 className='text-[36px]'>
                    <span>Transforming digital</span> <br />
                    <span className='text-[#FB5E00]'>
                        Finance Solutions
                    </span>
                </h1>
                <p className='text-[15px] font-light'>Elementra is dedicated to transforming the digital finance landscape, empowering users with innovative solutions for financial freedom.</p>
